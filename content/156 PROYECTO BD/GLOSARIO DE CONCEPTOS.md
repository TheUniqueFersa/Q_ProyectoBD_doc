...
| Concepto                                         | Sinónimo                                                |
| ------------------------------------------------ | ------------------------------------------------------- |
| [[2.CORREDOR DE SEGURO]]                         | Asesor Comercial, Empleado, Asesor, ==Cotizador== [^1]  |
...
[^2]: Se descarta la definición de glosa de algunos autores que se refieren a ella como una "**no conformidad que afecta en forma parcial o total el valor de la factura por prestación de servicios de salud**", pues no aplica, además de que encaja mejor "un añadido" en el contexto de [[6. DESCRIPCIÓN NARRATIVA#Administrar planes]]
